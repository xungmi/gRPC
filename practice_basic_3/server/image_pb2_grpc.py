...
class ImageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadImage = channel.unary_unary(
                ...
                response_deserializer=image__pb2.ImageUploadResponse.FromString,
                _registered_method=True)
        self.UploadImageStream = channel.stream_unary(
                '/imageservice.ImageService/UploadImageStream',
...
def add_ImageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UploadImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=image__pb2.ImageUploadResponse.SerializeToString,
            ),
...
class ImageService(object):
    ...
    def UploadImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            image__pb2.ImageUploadResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
